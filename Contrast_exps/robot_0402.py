...
if __name__ == '__main__':
    ...
    while True:
        order1 = conflict_detection([r1.location_x,r1.location_y,r1.velocity,r1.heading],[[r2.location_x,r2.location_y],[r3.location_x,r3.location_y],[r4.location_x,r4.location_y]])
        if order1:
        ...
        order3 = conflict_detection([r3.location_x, r3.location_y, r3.velocity, r3.heading],
                                    [[r1.location_x, r1.location_y, r1.velocity, r1.heading],
                                     [r2.location_x, r2.location_y, r2.velocity, r2.heading],[r4.location_x,r4.location_y,r4.velocity,r4.heading]])
        if order3:
        ...
        if get_distance([r1.location_x, r1.location_y], [r1.target_x, r1.target_y]) < 3 and get_distance(
            ...
            [r4.location_x, r4.location_y], [r4.target_x, r4.target_y]) < 3:
            break
    ...
    expected_length = get_distance([tr_r1[0][0], tr_r1[1][0]], [tr_r1[0][-1], tr_r1[1][-1]]) + get_distance(
        ...
        [tr_r4[0][0], tr_r4[1][0]], [tr_r4[0][-1], tr_r4[1][-1]])
    min_distance = []
    Trajectory = [tr_r1, tr_r2, tr_r3, tr_r4]
