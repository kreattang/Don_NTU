...
def main(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10):
    start = time.time()
    used_time = 0
    ...
    r9 = Robot(P9[0], P9[1],  'lightskyblue')
    r10 = Robot(P10[0], P10[1], 'tan')

    robot_list = [r1, r2, r3, r4, r5, r6, r7, r8, r9, r10]
...
if __name__ == '__main__':
    ...
    for i in range(75):
        ...
        UAV9_start_x, UAV9_start_y = random.randint(-300, 10), random.randint(10, 300)
        UAV9_target_x, UAV9_target_y = random.randint(10, 300), random.randint(-300, 10)
        UAV10_start_x, UAV10_start_y = random.randint(-300, 10), random.randint(-300, 10)
        UAV10_target_x, UAV10_target_y = random.randint(10, 300), random.randint(10, 300)
        ...
        print("坐标信息：", [[UAV1_start_x, UAV1_start_y], [UAV1_target_x, UAV1_target_y]], \
              ...
              [[UAV9_start_x, UAV9_start_y], [UAV9_target_x, UAV9_target_y]], \
              [[UAV10_start_x, UAV10_start_y], [UAV10_target_x, UAV10_target_y]]
              )
        try:
            Sep, Tra, Time = \
