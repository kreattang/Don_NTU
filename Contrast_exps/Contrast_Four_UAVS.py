#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2019/5/12 19:18
# @Author  : blvin.Don
# @File    : Contrast_Four_UAVS.py
...
def main(P1, P2, P3, P4):
    ...
    while True:
        ...
        for r in robot_list:
            if get_distance([r.location_x, r.location_y], [r.target_x, r.target_y]) < 20:
                target = target + 1
            else:
...
if __name__ == '__main__':
    ...
    for i in range(50):
        ...
        UAV2_start_x, UAV2_start_y = random.randint(-300, -200), random.randint(-300, -200)
        UAV2_target_x, UAV2_target_y = random.randint(200, 300), random.randint(200, 300)
        UAV3_start_x, UAV3_start_y = random.randint(200, 300), random.randint(-300, -200)
        UAV3_target_x, UAV3_target_y = random.randint(-300, -200), random.randint(200, 300)
        UAV4_start_x, UAV4_start_y = random.randint(200, 300), random.randint(200, 300)
        UAV4_target_x, UAV4_target_y = random.randint(-300, -200), random.randint(-300, -200)
