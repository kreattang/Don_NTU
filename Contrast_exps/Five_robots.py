...
if __name__ == '__main__':
    ...
    while True:
        order1 = conflict_detection([r1.location_x,r1.location_y,r1.velocity,r1.heading],[[r2.location_x,r2.location_y],[r3.location_x,r3.location_y],[r4.location_x,r4.location_y],[r5.location_x, r5.location_y, r5.velocity, r5.heading]])
        if order1:
        ...
        order2 = conflict_detection([r2.location_x, r2.location_y, r2.velocity, r2.heading],
                                    [[r1.location_x, r1.location_y, r1.velocity, r1.heading],
                                     ...
                                     [r4.location_x, r4.location_y, r4.velocity, r4.heading],[r5.location_x, r5.location_y, r5.velocity, r5.heading]])
        if order2:
        ...
        order3 = conflict_detection([r3.location_x, r3.location_y, r3.velocity, r3.heading],
                                    [[r1.location_x, r1.location_y, r1.velocity, r1.heading],
                                     [r2.location_x, r2.location_y, r2.velocity, r2.heading],[r4.location_x,r4.location_y,r4.velocity,r4.heading],[r5.location_x, r5.location_y, r5.velocity, r5.heading]])
        if order3:
        ...
        order4 = conflict_detection([r4.location_x, r4.location_y, r4.velocity, r4.heading],
                                    [[r1.location_x, r1.location_y, r1.velocity, r1.heading],
                                     ...
                                     [r3.location_x, r3.location_y, r3.velocity, r3.heading],[r5.location_x, r5.location_y, r5.velocity, r5.heading]])
        if order4:
        ...
        order5 = conflict_detection([r5.location_x, r5.location_y, r5.velocity, r5.heading],
                                    [[r1.location_x, r1.location_y, r1.velocity, r1.heading],
                                     [r2.location_x, r2.location_y, r2.velocity, r2.heading],
                                     [r3.location_x, r3.location_y, r3.velocity, r3.heading],[r4.location_x, r4.location_y, r4.velocity, r4.heading]])
        ...
        if get_distance([r1.location_x, r1.location_y], [r1.target_x, r1.target_y]) < 3 and get_distance(
            ...
            [r5.location_x, r5.location_y], [r5.target_x, r5.target_y]) < 3:
            break
    ...
    length_to_target = min(len(tr_r1[0]), len(tr_r2[0]), len(tr_r3[0]), len(tr_r4[0]))
    ...
    expected_length = get_distance([tr_r1[0][0], tr_r1[1][0]], [tr_r1[0][-1], tr_r1[1][-1]]) + get_distance(
        ...
        [tr_r5[0][0], tr_r5[1][0]], [tr_r5[0][-1], tr_r5[1][-1]])
    min_distance = []
    Trajectory = [tr_r1, tr_r2, tr_r3, tr_r4,tr_r5]
    # print(Trajectory[0][0])
    # print("计算Fitness！")
    for j in range(5):
        for k in range(j + 1, 5):
            for i in range(min(len(tr_r1[0]), len(tr_r2[0]), len(tr_r3[0]), len(tr_r4[0]))):
